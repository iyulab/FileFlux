...
/// <summary>
/// Shared image processing logic for extract and chunk commands
/// </summary>
public class ImageProcessor
{
    ...
    public ImageProcessor(ImageProcessingOptions options, bool verbose = false)
    {
        _options = options;
        _verbose = verbose;
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        foreach (Match match in matches)
        {
            ...
            try
            {
                ...
                var replacement = BuildImageReplacement(processedImage, relativePath);
    ...
    private static (int Width, int Height) GetWebpDimensions(byte[] data)
    {
        ...
        // WebP VP8: dimensions at bytes 26-29
