...
public class ParsingOptions
{
    ...
    /// the service's literal (0.7) applied. The model itself is the analysis service's (its constructor / DI
    /// registration) — the former <c>LlmModel</c> here was read by nothing and was removed in 0.25.0.
    /// Default: 0.3
    /// </summary>
