...
public class WordDocumentReaderTests
{
    ...
    {
        // Arrange
        var testFile = @"D:\data\FileFlux\tests\test-docx\demo.docx";
    ...
    public async Task ExtractAsync_WithStream_ShouldExtractContent()
    {
        ...
        // Act
        var result = await _reader.ExtractAsync(fileStream, "demo.docx", null, CancellationToken.None);
